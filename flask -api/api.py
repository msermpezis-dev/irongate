...
api.add_resource(UnlockChangePW, "/unlock")
api.add_resource(ChangePW, "/changepw")
api.add_resource(CheckMail, "/checkmail")
api.add_resource(SendEmail, "/sendmail")
